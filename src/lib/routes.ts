...
export interface Route {
  ...
  waypoints: Waypoint[];
  /** Cover image URL for the route card (Wikimedia Commons). */
  coverImage: string;
...
export const routes: Route[] = [
  {
    ...
    waypoints: [
      ...
      {
        lat: 37.9681, lng: 23.7411, name: "Panathenaic Stadium", distanceFromStart: 1.3, streetViewHeading: 150,
      ...
      {
        lat: 37.9693, lng: 23.7330, name: "Temple of Olympian Zeus", distanceFromStart: 2.2, streetViewHeading: 320,
      ...
      {
        lat: 37.9745, lng: 23.7279, name: "Plaka — Tower of the Winds", distanceFromStart: 3.2, streetViewHeading: 90,
      ...
      {
        lat: 37.9715, lng: 23.7268, name: "The Acropolis", distanceFromStart: 3.7, streetViewHeading: 310,
      ...
      {
        lat: 37.9709, lng: 23.7242, name: "Odeon of Herodes Atticus", distanceFromStart: 4.0, streetViewHeading: 250,
      ...
      {
        lat: 37.9693, lng: 23.7202, name: "Filopappou Hill", distanceFromStart: 4.6, streetViewHeading: 180,
      ...
      {
        lat: 37.9763, lng: 23.7222, name: "Ancient Agora", distanceFromStart: 5.6, streetViewHeading: 180,
      ...
      {
        lat: 37.9784, lng: 23.7168, name: "Kerameikos Cemetery", distanceFromStart: 6.3, streetViewHeading: 270,
      ...
      {
        lat: 37.9484, lng: 23.6441, name: "Piraeus Port", distanceFromStart: 16, streetViewHeading: 200,
  ...
  },
  {
    ...
    waypoints: [
      ...
      {
        lat: 52.3752, lng: 4.8840, name: "Anne Frank House", distanceFromStart: 1.6, streetViewHeading: 120,
      ...
      {
        lat: 52.3710, lng: 4.8848, name: "Nine Streets", distanceFromStart: 2.2, streetViewHeading: 200,
      ...
      {
        lat: 52.3642, lng: 4.8838, name: "Leidseplein", distanceFromStart: 3.3, streetViewHeading: 90,
      ...
      {
        lat: 52.3600, lng: 4.8852, name: "Rijksmuseum", distanceFromStart: 3.9, streetViewHeading: 350,
      ...
      {
        lat: 52.3668, lng: 4.8936, name: "Bloemenmarkt", distanceFromStart: 5.3, streetViewHeading: 135,
      ...
      {
        lat: 52.3662, lng: 4.8975, name: "Rembrandtplein", distanceFromStart: 5.7, streetViewHeading: 45,
      ...
      {
        lat: 52.3685, lng: 4.9044, name: "Waterlooplein", distanceFromStart: 6.4, streetViewHeading: 180,
      ...
      {
        lat: 52.3662, lng: 4.9162, name: "Artis Zoo", distanceFromStart: 7.5, streetViewHeading: 90,
      ...
      {
        lat: 52.3740, lng: 4.9122, name: "NEMO Science Museum", distanceFromStart: 8.7, streetViewHeading: 270,
      ...
      {
        lat: 52.3745, lng: 4.8848, name: "Westerkerk", distanceFromStart: 11.2, streetViewHeading: 90,
      ...
      {
        lat: 52.3770, lng: 4.8780, name: "Jordaan District", distanceFromStart: 12, streetViewHeading: 45,
  ...
  },
  {
    ...
    waypoints: [
      ...
      {
        lat: 30.0473, lng: 31.2623, name: "Khan el-Khalili Bazaar", distanceFromStart: 3.5, streetViewHeading: 90,
      ...
      {
        lat: 30.0459, lng: 31.2631, name: "Al-Azhar Mosque", distanceFromStart: 3.7, streetViewHeading: 180,
      ...
      {
        lat: 30.0285, lng: 31.2598, name: "Citadel of Saladin", distanceFromStart: 6.4, streetViewHeading: 270,
      ...
      {
        lat: 30.0226, lng: 31.2493, name: "Ibn Tulun Mosque", distanceFromStart: 8.0, streetViewHeading: 140,
      ...
      {
        lat: 30.0053, lng: 31.2296, name: "Old Cairo", distanceFromStart: 11.6, streetViewHeading: 200,
      ...
      {
        lat: 29.9980, lng: 31.2398, name: "Fustat Ruins", distanceFromStart: 13.4, streetViewHeading: 160,
      ...
      {
        lat: 29.9850, lng: 31.2300, name: "Nile Corniche", distanceFromStart: 15.7, streetViewHeading: 250,
      ...
      {
        lat: 29.9870, lng: 31.1700, name: "Giza Plateau", distanceFromStart: 23.5, streetViewHeading: 220,
      ...
      {
        lat: 29.9779, lng: 31.1336, name: "Solar Boat Museum", distanceFromStart: 28.4, streetViewHeading: 60,
      ...
      {
        lat: 29.9753, lng: 31.1376, name: "The Great Sphinx", distanceFromStart: 29.1, streetViewHeading: 45,
      ...
      {
        lat: 29.9792, lng: 31.1320, name: "Great Pyramid of Giza", distanceFromStart: 30, streetViewHeading: 90,
